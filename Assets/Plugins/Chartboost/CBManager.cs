...
namespace Chartboost {
	public class CBManager : MonoBehaviour {
		...
		void Awake() {
            ...
            GameObject ChartBoostManager = GameObject.Find("ChartBoostManager");
            GameObject[] children = (GameObject[])GameObject.FindObjectsOfType(typeof(GameObject));
            ...
            foreach (GameObject GameObjectchild in children )
            {
                if (GameObjectchild.name == "ChartBoostManager")
                    ++count;
            }
		}
